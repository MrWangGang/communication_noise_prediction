...
# ========================= 4. 绘图函数 =========================
def plot_metrics(train_loss, val_loss, r2, r, rmse, mse, mae, ccc, save_path='training_metrics_lstm.png'):
...
if __name__ == '__main__':
    ...
    norm_params_path = './norm_params_lstm.pkl'
    ...
    plot_metrics(train_loss_list, val_loss_list, r2_list, r_list, rmse_list, mse_list, mae_list, ccc_list)