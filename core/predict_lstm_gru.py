...
def main(start_index, end_index):
    ...
    # 修改模型保存路径以匹配新的模型结构
    model_save_path = './model/lstm_transformer/best_model_lstm_gru.pth'
    norm_params_path = './model/lstm_transformer/norm_params_lstm_gru.pkl'
    # 修改输出文件名以反映新的模型
    output_xlsx_path = f'./prediction_lstm_gru_{start_index}_to_{end_index}.xlsx'
